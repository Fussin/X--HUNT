# Agent Instructions for blackphoenix Repository

This document provides guidance for AI agents working on the blackphoenix codebase.

## Project Overview

This is a monorepo for blackphoenix, an AI-powered cybersecurity framework. The project is composed of multiple modules written in different languages. Refer to the `README.md` for the high-level project structure.
